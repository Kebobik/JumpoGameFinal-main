...
public class CameraShake : MonoBehaviour
{
     ...
     public IEnumerator StartShake()
    {
        ...
        vCamera.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_AmplitudeGain = 4;
        vCamera.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_FrequencyGain = 4;
